...
\<CR>
\<CR><body>
\<CR><script type="text/javascript" src="http://yui.yahooapis.com/3.1.1/build/yui/yui-min.js"></script>
\<CR></body>
\<CR>
\<CR></html>
...
iab ayui <script type="text/javascript" src="http://yui.yahooapis.com/3.1.1/build/yui/yui-min.js"></script>
